...
const BOT_RESPONSES: Record<string, Message> = {
  ...
  "Tell me about the warranty": {
    id: 0,
    text: "Every project includes our Matlock Shield warranty:\n\n🛡️ 3 Years — Workmanship & Materials\n🛡️ 6 Years — Building Envelope\n🛡️ 11 Years — Structural Integrity\n\nThis goes beyond the industry standard and is backed directly by us.",
    sender: "bot",
