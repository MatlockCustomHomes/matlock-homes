...
const reviews: Review[] = [
  ...
  {
    quote: "I can't express how thrilled I am with Matlock Homes' work. From the initial consultation to the final walkthrough, every detail was handled with care. The quality is top-notch, and their team is friendly and communicative. Choose Matlock Homes!",
    name: "Satisfied Homeowner",
    location: "New Port Richey, FL",
  ...
  {
    quote: "Matlock Homes exceeded my expectations! They tore down our old home and built us a brand-new dream house on the same lot. Their team was professional, skilled, and completed the project ahead of schedule. Highly recommend!",
    name: "Satisfied Homeowner",
    location: "New Port Richey, FL",
    project: "Full Home Rebuild",
    rating: 5,
  },
];
